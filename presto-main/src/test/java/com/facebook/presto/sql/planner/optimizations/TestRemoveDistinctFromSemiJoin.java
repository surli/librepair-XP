...
{
    public TestRemoveDistinctFromSemiJoin()
    {
        super(ImmutableMap.of(SystemSessionProperties.REMOVE_DISTINCT_FROM_SEMIJOIN, "true"));
    }
        ...
        assertPlan(
                ...
                anyTree(
                        semiJoin("Source", "Filter", "Output",
                                ...
                                project(anyNot(AggregationNode.class,
