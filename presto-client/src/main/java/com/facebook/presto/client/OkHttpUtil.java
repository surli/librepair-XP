...
public final class OkHttpUtil
{
            ...
            Optional<String> trustStorePassword)
    {
        ...
        try {
            ...
            // patch IPv6 canonicalization
            // TODO: fix in OkHttp: https://github.com/square/okhttp/pull/3272
            clientBuilder.hostnameVerifier((host, session) -> {
                if (isInetAddress(host)) {
                    host = toAddrString(InetAddresses.forString(host));
                }
                return OkHostnameVerifier.INSTANCE.verify(host, session);
            });
        }
