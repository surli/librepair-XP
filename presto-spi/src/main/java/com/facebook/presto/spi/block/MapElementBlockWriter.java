...
public class MapElementBlockWriter
        ...
        implements BlockBuilder
{
    ...
    MapElementBlockWriter(int start, BlockBuilder keyBlockBuilder, BlockBuilder valueBlockBuilder)
    {
    ...
    {
        StringBuilder sb = new StringBuilder("MapElementBlockWriter{");
