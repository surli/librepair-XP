...
public class MapElementBlock
        extends AbstractMapElementBlock
{
    private static final int INSTANCE_SIZE = ClassLayout.parseClass(MapElementBlockWriter.class).instanceSize();
    ...
    MapElementBlock(int offset, int positionCount, Block keyBlock, Block valueBlock, int[] hashTable, Type keyType, MethodHandle keyNativeHashCode, MethodHandle keyBlockNativeEquals)
    {
    ...
    {
        return new MapElementBlockEncoding(keyType, keyNativeHashCode, keyBlockNativeEquals, keyBlock.getEncoding(), valueBlock.getEncoding());
    }
